...
public class FixedMockMvcClientHttpRequestFactory
    implements ClientHttpRequestFactory, org.springframework.http.client.AsyncClientHttpRequestFactory {

    private final MockMvc mockMvc;


    public FixedMockMvcClientHttpRequestFactory(MockMvc mockMvc) {
    ...
    private ClientHttpResponse getClientHttpResponse(
        ...
        try {
            ...
            // reported as https://github.com/spring-projects/spring-framework/issues/26720
            if(servletResponse.getErrorMessage() != null) {
                body = servletResponse.getErrorMessage().getBytes(StandardCharsets.UTF_8);
            }
